  ...
  return (
    <div className="mx-auto w-full max-w-6xl px-6 py-12 md:py-16">
      <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        <div>
          <h1 className="font-heading text-4xl tracking-tight text-brand-gold md:text-5xl">Projects</h1>
      ...
      <div className="mt-10 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
        {projects.map((project) => (
          <article key={project.title} className="frost-card rounded-3xl p-6">
            ...
            <h2 className="mt-3 text-2xl font-semibold tracking-tight text-brand-gold">{project.title}</h2>
