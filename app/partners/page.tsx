...
export default function PartnersPage() {
  return (
    <div className="mx-auto w-full max-w-6xl px-6 py-12 md:py-16">
      <h1 className="font-heading text-4xl tracking-tight text-brand-green md:text-5xl">Partners</h1>
      ...
      <section className="mt-10 grid gap-6 md:grid-cols-2">
        <div className="frost-card rounded-3xl p-6 md:p-8">
          <h2 className="text-2xl font-semibold tracking-tight text-brand-green">Become a Partner</h2>
        ...
        <div className="frost-card rounded-3xl p-6 md:p-8">
          <h2 className="text-2xl font-semibold tracking-tight text-brand-green">Partnership Opportunities</h2>
      ...
      <section className="mt-10 rounded-3xl p-8 frost-card">
        <h2 className="font-heading text-3xl tracking-tight text-brand-green">Build with us</h2>
