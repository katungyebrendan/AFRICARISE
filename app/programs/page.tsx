...
export default function ProgramsPage() {
  return (
    <div className="mx-auto w-full max-w-6xl px-6 py-12 md:py-16">
      <h1 className="font-heading text-4xl tracking-tight text-brand-gold md:text-5xl">Our Programs</h1>
      ...
      <div className="mt-10 grid gap-6 xl:grid-cols-2">
        {programs.map((program) => (
          <section key={program.title} className="frost-card rounded-3xl p-6 md:p-8">
            <h2 className="text-2xl font-semibold tracking-tight text-brand-gold">{program.title}</h2>
