  ...
  return (
    <div className="mx-auto w-full max-w-6xl px-6 py-12 md:py-16">
      ...
      <section className="mt-10 rounded-3xl p-8 frost-card">
        <h2 className="font-heading text-2xl tracking-tight text-brand-green">Who We Are</h2>
      ...
      <section className="mt-10 grid gap-4 md:grid-cols-3">
        <article className="frost-card rounded-2xl p-6">
          <h3 className="text-xl font-semibold text-brand-green">Vision Statement</h3>
        ...
        <article className="frost-card rounded-2xl p-6">
          <h3 className="text-xl font-semibold text-brand-green">Mission Statement</h3>
          <p className="mt-2 text-sm leading-6 text-foreground/80">
        ...
        <article className="frost-card rounded-2xl p-6">
          <h3 className="text-xl font-semibold text-brand-green">Approach</h3>
          <p className="mt-2 text-sm leading-6 text-foreground/80">
