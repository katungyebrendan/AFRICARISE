    ...
    <div className="mx-auto w-full max-w-6xl px-6 py-12 md:py-16">
      ...
      <div className="mt-10 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
        <section className="frost-card rounded-2xl p-6">
          <h2 className="text-2xl font-semibold tracking-tight text-brand-gold">Headquarters</h2>
        ...
        <section className="frost-card rounded-2xl p-6">
          <h2 className="text-2xl font-semibold tracking-tight text-brand-gold">Email</h2>
        ...
        <section className="frost-card rounded-2xl p-6">
          <h2 className="text-2xl font-semibold tracking-tight text-brand-gold">Phone</h2>
      ...
      <section className="mt-10 rounded-3xl p-8 frost-card">
        <h2 className="font-heading text-3xl tracking-tight text-brand-gold">Social Media</h2>
