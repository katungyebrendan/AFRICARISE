  ...
  return (
    <div className="mx-auto w-full max-w-6xl px-6 py-12 md:py-16">
      ...
      <div className="mt-10 grid gap-6 md:grid-cols-3">
        {newsItems.map((item) => (
          <article key={item.title} className="frost-card rounded-3xl p-6">
            ...
            <h2 className="mt-3 text-2xl font-semibold tracking-tight text-brand-green">{item.title}</h2>
      ...
      <section className="mt-10 rounded-3xl p-8 frost-card">
        <h2 className="font-heading text-3xl tracking-tight text-brand-green">Stay informed</h2>
